Feature: Graph Page Functionality
  ...
  Scenario: Graph homepage login Functionlity
  ...
  Scenario Outline: Graph home page functionality
    ...
    When user enters code in  tryeditor from excel sheet to "<SheetName>" and <rownumber> then click run, output is printed
    When users writes the code for invalid in tryeditor from "<Sheetname>" and <rownumber> then click ru
  ...
  Scenario Outline: GraphRepresentations page functionality
    ...
    When user enters code2 in  tryeditor from excel sheet to "<SheetName>" and <rownumber> then click run, output is printed
